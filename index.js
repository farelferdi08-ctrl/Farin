...
bot.onText(/^\/start(?:\s+(.+))?$/, async (msg, match) => {
    ...
    const caption = `<blockquote>👋 Halo, ${name}!\n━━━━━━━━━━━━━━━━━━━━━━━━━━\nSelamat datang di <b>FARIN SHOP</b> layanan OTP otomatis yang menyediakan nomor verifikasi untuk berbagai aplikasi dan negara secara cepat, stabil, dan tersedia 24/7.\n\n📌 <b>Informasi Layanan:</b>\nKetersediaan nomor dan harga dapat berubah sewaktu-waktu mengikuti kondisi sistem serta permintaan pasar.\n\n🚀 <b>Silakan pilih menu di bawah untuk mulai menggunakan layanan kami</b></blockquote>`;
